...
Bugs would always Play_Near because then his payoff would be $+1$, whereas Play_Far would get him a payout of $-2$. (The payoffs are all written from the perspective of Fudd, so Bugs's are opposite.)
