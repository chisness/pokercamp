...
We developed this game to show concepts in games with **imperfect information** that are applicable to our first challenge. Imperfect information games involve hidden information, which could be cards in poker or enemy location in the Hunting Wabbits game. In perfect information games like chess, all information is available to both players. 
...
:::{.callout-warning collapse="true"  appearance="minimal"}
## Solution
Since the game is zero-sum, we can find Fudd's expected value:
