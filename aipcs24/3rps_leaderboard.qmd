...
## RPS, various opponents

<div id="leaderboard-1"></div>

## Paper - Maybe Scissors - Maybe Rock

<div id="leaderboard-2"></div>

<script>
  function fetchLeaderboard(board_number) {
    fetch(`https://pokercamp-staff-dev1.rossry.net:1443/challenge-3-psmr/leaderboard-${board_number}`)
      .then(response => response.json())
      .then(data => {
        const leaderboardDiv = document.getElementById(`leaderboard-${board_number}`);
