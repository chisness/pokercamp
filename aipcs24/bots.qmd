...
1. `turn`: Which player is acting

2. `street`: Current betting round

3. `pips`: How much each player has contributed to the pot on the current hand 

4. `stacks`: 

5. `hands`: List of known hands to you

6. `deck`: 

7. `action_history`: History of actions

8. `previous_state`: The previous state of the hand
