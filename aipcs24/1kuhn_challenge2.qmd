...
You'll have to refresh the page to see the leaderboard change. Re-running the tournament currently takes between one and three minutes (but could be longer, since it's quadratic in entries), and there's no indication that it's done except the board changing. Working on improvements.
:::
