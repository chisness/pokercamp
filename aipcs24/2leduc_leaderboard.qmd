...
<div id="leaderboard-100cardkuhn"></div>

## Leduc Poker

<div id="leaderboard-leduc"></div>

<script>
  function fetchLeaderboard(game_name) {
    fetch(`https://pokercamp-staff-dev1.rossry.net:1443/challenge-2-${game_name}/leaderboard`)
      .then(response => response.json())
      .then(data => {
        const leaderboardDiv = document.getElementById(`leaderboard-${game_name}`);
  ...
  fetchLeaderboard("100cardkuhn");
  fetchLeaderboard("leduc");
</script>