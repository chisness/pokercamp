...
4. <span class="infoset p2">Q_↓↑</span>: <span class="gamenode">Q</span> as Player 1 checking and then facing a bet
 - Should always play <span class="gamenode">↓</span> fold

5. <span class="infoset p2">A_↓↑</span>: <span class="gamenode">A</span> as Player 2 checking and then facing a bet
 - Should always play <span class="gamenode">↑</span> bet
