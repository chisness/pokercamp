...
Try to find a pair of no-regret full strategies in the boxes below for <span class="player p1"></span> and <span class="player p2"></span>.

Hint: There are some "automatic" infoset strategies such that it only makes sense to play 100% of one action in the game. 

When you get each infoset to at most 0.1 chips of EV away from regret-free, a link to the next stage will appear next. 
