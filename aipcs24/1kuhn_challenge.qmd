---
title: "#1: Kuhn Poker | Challenge (Part )"
sidebar: aipcs24
format:
  html:
    math: true
...
When you get a pair of strategies such that each infoset is at most 0.1 chips of EV away from regret-free, a link to the next stage will appear at the bottom of the page.
...
<div id="unlock_next" style="display:none">
  <p><a href=1kuhn_challenge2.html>Enter Part 2</a></p>
</div>
