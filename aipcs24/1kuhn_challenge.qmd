...
2. About what happens after an action, which depends on the probabilities down the game tree

## Challenge 1
The goal of this challenge is to find optimal strategies for Kuhn Poker by adjusting the individual strategies at each of the 12 infosets. Optimal here means Nash equilibrium regret-minimizing strategies for both players. 
