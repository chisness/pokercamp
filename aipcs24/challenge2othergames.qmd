...
Go over results from tournament

Easy/pure strategies
Mixed strategies 

Regret
Regret matching
Gradient descent
https://chatgpt.com/c/5925b66e-7fdb-4139-84b5-3663b3636661 
How we did it in the interactive

Get fully into CFR next 
...
Now the payoff is $\frac{1}{3}*2 = 0.67$. 

When a player makes their opponent indifferent, this means that any action the opponent takes will result in the same payoff (within the set of equilibrium actions)! 
