...
We aren't intending to say much more about how the $X0$, $X1$ probabilities will be generated, and no your bot should not be communicating with itself between matchups or phoning home to you. (It should be storing info for itself round-to-round within a matchup, however.)
