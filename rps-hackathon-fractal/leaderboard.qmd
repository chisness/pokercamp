...
<script>
    ...
    async function fetchLeaderboardTestingData() {
        try {
            const response = await axios.get('https://staff-dev1.poker.camp:8442/leaderboard-rps-hackathon-20240908/latest');
    ...
    async function fetchLeaderboardScoringData() {
        try {
            const response = await axios.get('https://staff-dev1.poker.camp:8442/leaderboard-rps-hackathon-20240908/scoring');
            return response.data;
        } catch (error) {
            console.error('Error fetching data:', error);
            return null;
