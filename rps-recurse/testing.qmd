    ...
    async function initTable() {
        ...
        if (testingData) {
            ...
            testingInfoContainer.innerHTML = `
                <div class="tournament-info">
                    Started: ${formatDate(testingData.start_time)} | 
                    Ended: ${formatDate(testingData.end_time)} |
                    Mean Score: ${formatNumber(testingData.mean_score)}
                </div>
            `;
            ...
            for (const [opponent, score] of Object.entries(testingData.matchups)) {
