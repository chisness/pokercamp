...
<script>
    ...
    async function initHistories() {
        ...
        sortedRounds.forEach(roundDate => {
            ...
            summary.textContent = `Tournament #${roundData['tournament_info']['tournament_id']} | Started: ${formatDateMaybe(roundData['tournament_info']['start_time'])} | Ended: ${formatDateMaybe(roundData['tournament_info']['end_time'])}`;
