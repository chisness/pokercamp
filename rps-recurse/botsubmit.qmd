...
You can download this file in the [rps-engine repo](https://github.com/pokercamp/rps-engine) at `players/default/player.py` and for more info on testing see: [Game Engine](botguide.qmd/#game-engine).
...
const initialCode = `from skeleton.actions import RockAction, PaperAction, ScissorsAction
from skeleton.bot import Bot
from skeleton.runner import parse_args, run_bot
...
function autoSave() {
    ...
    localStorage.setItem('autoSavedCode', editor.getValue());
}
