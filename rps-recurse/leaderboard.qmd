...
<script>
    ...
    function createMatrixTable(data, isLatestRound = false, allRoundsData = null) {
        ...
        sortedPlayers.forEach((player, index) => {
            ...
            tableHTML += `<td>${formatNumber(player.mean)} × ${data.scoring_weight}</td>`;
    ...
    async function initTables() {
        ...
        if (data["next_round_name"] === null) {
            ...
            document.getElementById('next-round-name').innerHTML = `"${data["next_round_name"]}" at ${formatDateMaybe(data["next_round_time"])}`;
        }
    }
